...
module.exports = function(Piler) {
  ...
  JSManager = (function(_super) {
    ...
    JSManager.prototype._isReserved = function(ns) {
      if (Piler.utils.reserved.indexOf(ns) !== -1) {
    ...
    JSManager.prototype.addModule = function(ns, path, before) {
      var pile;
      if (before == null) {
        before = false;
      }
    ...
    JSManager.prototype.addOb = function(ns, ob, before) {
      var pile;
      if (before == null) {
        before = false;
      }
    ...
    JSManager.prototype.addExec = function(ns, fn, before) {
      var pile;
      if (before == null) {
        before = false;
      }
