'use strict';
var LiveUpdateDisabled, LiveUpdateMixin, clientUpdater, debug, e, fs, incUrlSeq, socketio;
...
clientUpdater = function() {
  ...
  pile.on("connect", function() {
    return debug("CSS updater has connected");
  });
  pile.on("disconnect", function() {
    return debug("CSS updater has disconnected! Refresh to reconnect");
  });
  return pile.on("update", function(fileId) {
    ...
    if (elem) {
      ...
      return debug("id", fileId, "not found");
    }
  });
};
...
LiveUpdateMixin = (function() {
  ...
  LiveUpdateMixin.prototype.liveUpdate = function(cssmanager, userio) {
    ...
    return listener.on("listening", (function(_this) {
      return function() {
  ...
  LiveUpdateMixin.prototype._watch = function(pile, codeOb) {
    ...
    return fs.watch(codeOb.filePath, (function(_this) {
      return function() {
