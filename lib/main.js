...
module.exports = function(classes, mainExports) {
   ...
   */
  var BasePile, PileManager, bindFn, debug, defNs, managers, out, piles, production;
  out = {
  ...
  PileManager = (function() {
    ...
    PileManager.prototype.add = function(ns, type, before) {
      var pile;
    ...
    PileManager.prototype.addFiles = function(ns, arr, before) {
      var file, _i, _len;
      if (before == null) {
        before = false;
      }
    ...
    PileManager.prototype.addFile = function(ns, path, before) {
      var pile;
      if (before == null) {
        before = false;
      }
    ...
    PileManager.prototype.addRaw = function(ns, raw, before) {
      var pile;
      if (before == null) {
        before = false;
      }
    ...
    PileManager.prototype.addUrl = function(ns, url, before) {
      var pile;
      if (before == null) {
        before = false;
      }
