module.exports = function(Piler, mainExports) {
   ...
   */
  var BasePile, PileManager, debug, managers, op, out, piles;
    ...
    BasePile.prototype.pileUp = function(cb) {
      ...
      return Piler.utils.Promise.map(this.assets, function(codeOb) {
        ...
        return codeOb.contents().then(function(code) {
          return "" + (self.options.commentLines ? self.commentLine("" + self.name + "." + (codeOb.type()) + "-" + (codeOb.id()) + "." + self.ext) : '') + "\n" + code;
        });
  ...
  PileManager = (function() {
    ...
    PileManager.prototype.addWildcard = function(arr, options, cb) {
      ...
      return Piler.utils.Promise.map(promises, (function(_this) {
    ...
    PileManager.prototype.addFile = function(path, options, cb) {
      this.add('addFile', path, options, cb);
      return this;
    };
    ...
    PileManager.prototype.addMultiline = function(fn, options, cb) {
      this.add('addMultiline', fn, options, cb);
      return this;
    };
    ...
    PileManager.prototype.addRaw = function(raw, options, cb) {
      this.add('addRaw', raw, options, cb);
      return this;
    };
    ...
    PileManager.prototype.addUrl = function(url, options, cb) {
      this.add('addUrl', url, options, cb);
      return this;
    };
    ...
    PileManager.prototype.getSources = function(namespaces) {
    ...
    PileManager.prototype.render = function(namespaces, cb) {
      namespaces = Piler.utils.ensureArray(namespaces);
      return Piler.utils.Promise.reduce(this.getSources(namespaces), (function(_this) {
    ...
    PileManager.prototype.stream = function(namespaces, options) {
      var main, namespace, pm, promises;
      ...
      return Piler.utils.through(function(chunk, enc, callback) {
        var promise, _i, _len;
        if (promises.length) {
          for (_i = 0, _len = promises.length; _i < _len; _i++) {
            promise = promises[_i];
            main = main.then(promise).then((function(_this) {
              return function(value) {
                _this.push(value);
              };
            })(this));
    ...
    PileManager.prototype.findAssetsBy = function(member, search, namespace, cb) {
      var pile, promise;
      if (namespace == null) {
        namespace = 'global';
      }
