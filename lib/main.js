...
module.exports = function(classes, mainExports) {
  ...
  BasePile = (function() {
    ...
    BasePile.prototype.minify = function(code, options) {
      ...
      if (this.options.production) {
        return classes.Minifiers.minify(this.ext, code, classes.utils._.merge({
  ...
  PileManager = (function() {
    ...
    PileManager.prototype.getPile = function(ns, settings) {
      ...
      pile = this.piles[ns];
      if (!pile) {
        return this.piles[ns] = new this.type(ns, classes.utils._.merge({}, this.options, settings));
      }
      return pile;
    };
    ...
    PileManager.prototype.pileUp = function(cb) {
      ...
      return classes.utils.Q.each(Object.keys(piles), function(name) {
        var pile;
        pile = piles[name];
