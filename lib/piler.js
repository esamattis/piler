 ...
 * @namespace Piler
 */
var BasePile, CSSManager, CSSPile, JSManager, JSPile, LiveUpdateMixin, OB, PileManager, asCodeOb, assetUrlParse, async, cache, compilers, crypto, cssMinify, debug, defNs, executableFrom, extension, fs, getCompiler, jsMinify, logger, path, production, reserved, toGlobals, _, _ref,
...
JSManager = (function(_super) {
  ...
  JSManager.prototype.setMiddleware = function(app) {
    var responseExec, responseOb, _this;
...
CSSManager = (function(_super) {
  ...
  CSSManager.prototype.setMiddleware = function(app) {
    var responseRaw, _this;
    debug('setting CSSManager middleware');
    _this = this;
    responseRaw = function(ob) {
      debug('res raw', ob);
