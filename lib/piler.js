'use strict';
var BasePile, CSSManager, CSSPile, JSManager, JSPile, LiveUpdateMixin, OB, PileManager, asCodeOb, assetUrlParse, async, compilers, crypto, cssMinify, debug, defNs, executableFrom, extension, fs, getCompiler, jsMinify, logger, path, production, reserved, toGlobals, wrapInScriptTagInline, _, _ref,
...
asCodeOb = (function() {
  ...
  pilers = {
    ...
    file: function(ob, cb) {
      return fs.readFile(ob.filePath, (function(_this) {
...
PileManager = (function() {
  ...
  PileManager.prototype.bind = function(app, server) {
    ...
    listener.on("listening", (function(_this) {
      return function() {
        _this.pileUp();
      };
    })(this));
